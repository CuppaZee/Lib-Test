...
const builds: Build[] = [
    ...
    },
    {
        ...
        fixes: [
            {
                description:
                    "Fixed the Universal Capper when all Universals have already been captured",
                thanks: "Obi-Cal",
            },
        ],
    },
    ...
    },
    {
        ...
        improvements: [
            {
                description:
                    "Moved some items to under a Tools dropdown on the Dashboard User Cards",
            },
        ],
        fixes: [
            {
    ...
    },
    {
        ...
        fixes: [
            {
                description:
                    "Adjusted Icon Size on Maps to scale for devices with different pixel ratios",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        fixes: [
            ...
            {
                description:
                    "Fixed colour labels not displaying on mobile in Personalisation settings.",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        improvements: [
            ...
            {
                description:
                    'Separated deploys on User Activity into "Deploys" and "Passive Deploys".',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        types: [
            ...
            {
                description:
                    "Each bouncer scatters out up to 3 of their respective scatters nearby!",
                types: [
                    ...db.types.filter(
                        i =>
                            i.category?.id === "seasonal_2021_womens-history-month" &&
    ...
    },
    {
        ...
        types: [
            ...
            },
            {
                ...
                description:
                    "CuppaZee now has the Amon-Ra and Osiris egyptian zodiacs in its database!",
        ...
        features: [
            {
                title: "Munzee Types",
                description:
                    "The Munzee Types section of CuppaZee has now been brought to CuppaZee V2!",
            },
        ],
        improvements: [
            {
    ...
    },
    {
        ...
        improvements: [
            {
                description:
                    "Improved configuration settings for Live Location for lower battery drain",
            },
            {
    ...
    },
    {
        ...
        improvements: [
            ...
            {
                description:
                    "Reworked User Activity Overview to support filtering and improve performance",
            },
            {
        ...
        types: [
            {
                title: "Lost Socks",
                types: db.types
                    .filter(i => i.category_raw === `seasonal_2021_lost-socks`)
                    .map(i => i.icon),
            },
        ],
    },
        ...
        types: [
            {
                ...
                types: ["3starresort", "3starresortroom", "4starresort", "4starresortroom", "5starresort","5starresortroom",],
            },
        ],
    },
];
