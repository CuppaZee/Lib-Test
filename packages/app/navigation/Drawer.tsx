      ...
      <DrawerGroup
        ...
        accessoryLeft={() => (
          <Image
            source={{
              uri:
                "https://munzee.global.ssl.fastly.net/images/avatars/ua2p5m.png",
            }}
            style={{
              height: 32,
              marginVertical: -4,
      ...
      >
        <DrawerItem
          selected={
            page[1]?.name === "User" &&
            page[2]?.name === "Profile" &&
            (page[2]?.params as any)?.username === "sohcah"
          }
          title="Profile"
          accessoryLeft={(props) => <Icon {...props} name="account" />}
          onPress={() =>
            props.navigation.navigate("User", {
              params: { username: "sohcah" },
              screen: "Profile",
            })
          }
        />
        <DrawerItem
          ...
          onPress={() =>
            props.navigation.navigate("User", {
              params: { username: "sohcah", date: "2020-12-24" },
              screen: "Activity",
            })
          }
        />
